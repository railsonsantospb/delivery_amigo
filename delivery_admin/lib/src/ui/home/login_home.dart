...
import 'package:deliveryadmin/src/home_page.dart';
                ...
                new Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      errorText:
                          _isFieldCpfLoginValid == null || _isFieldCpfLoginValid
                              ? null
                              : "O cpf é obrigatório",
                    ),
                    onChanged: (value) {
                      ...
                      if (isFieldValid != _isFieldCpfLoginValid) {
                        if (this.mounted) {
                          setState(() => _isFieldCpfLoginValid = isFieldValid);
                        }
                      }
                    },
                  ),
                    ...
                    onPressed: () {
                      ...
                      if (_isFieldPasswordLoginValid == null ||
                        ...
                        _apiServiceCop.getCopCpf(c).then((cpf) {
                          ...
                          if (cpf != null) {
                            if (cpf.isNotEmpty) {
                              if (_controllerPasswordLogin.text.toString() ==
                                  cpf[0].password) {
                                if (this.mounted && cpf != null) {
                                  if (CPF.isValid(c)) {
                                    ...
                                    alertShow("CPF Inválido!");
                                  }
                                } else {
                                  alertShow("CPF Inválido ou Já Cadastrado");
                                }
                              } else {
                            ...
                            Future.delayed(Duration(seconds: 5)).then((value) {
                              pr.hide().whenComplete(() {
                                if (_currentPosition == null) {
                                  ...
                                  String owner =
                                      _controllerOwner.text.toString();
                                  String address =
                                  ...
                                  _apiServiceCop
                                    ...
                                    if (isSuccess) {
                                      ...
                                      alertShow("Falha ao Enviar os Dados");
                                    }
                                  });
                                }
                              });
