...
class RequestX {
  ...
  @override
  String toString() {
    return 'RequestX{id: $id, client: $client, city: $city, active: $active, price_full: $price_full, products: $products, '
        ' date: $date, address: $address, lat: $lat, lon: $lon, email: $email, phone: $phone, id_cop: $id_cop, pay: $pay, obs: $obs';
  }
}
